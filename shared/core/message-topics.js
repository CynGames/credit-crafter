...
exports.HEALTH_RESPONSE = 'health-response';
// User
exports.USER_CREATE_REQUEST = 'user-create-request';
exports.USER_CREATE_RESPONSE = 'user-create-response';
exports.USER_FETCH_REQUEST = 'user-fetch-request';
exports.USER_FETCH_RESPONSE = 'user-fetch-response';
// Financial Data
exports.FINANCIAL_DATA_CREATE_REQUEST = 'financial-data-create-request';
exports.FINANCIAL_DATA_CREATE_RESPONSE = 'financial-data-create-response';
exports.FINANCIAL_DATA_FETCH_REQUEST = 'financial-data-fetch-request';
exports.FINANCIAL_DATA_FETCH_RESPONSE = 'financial-data-fetch-response';
// Loan
exports.LOAN_CREATE_REQUEST = 'loan-create-request';
